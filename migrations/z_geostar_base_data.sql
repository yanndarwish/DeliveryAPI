...
CALL geostar.sp_create_company('GEOSTAR', TRUE, '12345678901234', 'geostar@mail.com', '0101010101','[{},{}]', 1, 'Main Street', 'Cityville', 12345, 'Countryland', 'warehouse comment', 1, 'Main Street', 'Cityville', 12345, 'Countryland', 'headquarter comment');
CALL geostar.sp_create_company('DMT', TRUE, '12345678901234', 'dmt@mail.com', '0101010101','[{},{}]', 2, 'Oak Avenue', 'Townburg', 56789, 'Countrytop','warehouse comment', 2, 'Oak Avenue', 'Townburg', 56789, 'Countrytop', 'headquarter comment');
CALL geostar.sp_create_company('JLR', TRUE, '12345678901234', 'jlr@mail.com', '0101010101','[{},{}]', 3, 'Pine Road', 'Villagetown', 10111, 'Countryville','warehouse comment', 3, 'Pine Road', 'Villagetown', 10111, 'Countryville', 'headquarter comment');
CALL geostar.sp_create_company('TEST', TRUE, '12345678901234', 'test@mail.com', '0101010101','[{},{}]', 2, 'Oak Avenue', 'Townburg', 56789, 'Countrytop','warehouse comment',2, 'Oak Avenue', 'Townburg', 56789, 'Countrytop', 'headquarter comment');
...
-- Insert sample relay
CALL geostar.sp_create_relay('Relay One', 1, 'Main Street', 'Cityville', 12345, 'Countryland', TRUE, 1);
CALL geostar.sp_create_relay('Relay Two', 2, 'Oak Avenue', 'Townburg', 56789, 'Countrytop', FALSE, 1);
CALL geostar.sp_create_relay('Relay Three', 3, 'Pine Road', 'Villagetown', 10111, 'Countryville', TRUE, 1);
